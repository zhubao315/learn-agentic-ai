...
<head>
    ...
    <title>examples.py (editing)</title>
...
data-base-url="/"
data-file-path="L2/examples.py"

  
    data-jupyter-api-token="GBT2_y7e0r0RDkm7koo4JALMEAM517ciXLbVKAMlIr2_NPratPsmF_gHMOyphgfp"
...
<div id="header" role="navigation" aria-label="Top Menu">
  ...
  <div id="ipython_notebook" class="nav navbar-brand"><a href="/tree?token=GBT2_y7e0r0RDkm7koo4JALMEAM517ciXLbVKAMlIr2_NPratPsmF_gHMOyphgfp" title='dashboard'>
